...
class DamatuApi():
    ID = '54209'
    KEY = 'ace4337179bbcf3053ca98116d60a622'
    ...
    # 查看http://wiki.dama2.com/index.php?n=ApiDoc.Pricedesc  return 是答案为成功 如果为负数 则为错误码
...
dmt = DamatuApi("Monkey_D_Lufy", "xujiabo666")
if __name__ == '__main__':
    # 2.调用方法：
    print(dmt.getBalance())  # 查询余额
    print(dmt.decode('captcha.jpg', 287))  # 上传打码
    # print(dmt.decodeUrl('https://kyfw.12306.cn/passport/captcha/captcha-image?login_site=E&module=login&rand=sjrand',200)) #上传打码
